...
window.addEventListener('scroll', () => {
    ...
    sectionAll.forEach((current) => {
        ...
        if (!navLink) return; // Evita errores si no existe el enlace
...
// Solo agrega el eventListener si existe flagsElement
if (flagsElement) {
...
// ===== Formulario contacto con alerta y sin redirección =====
